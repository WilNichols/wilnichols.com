...
{% renderTemplate "njk" %}
{%- from 'uniuqe/case-study-diliegence.njk' import DiligenceAnnotatedWindow %}
...
{% renderTemplate "njk" %}
{%- from 'uniuqe/case-study-diliegence.njk' import DiligenceDetailWindow %}
...
{% renderTemplate "njk" %}
{%- from 'uniuqe/case-study-diliegence.njk' import DiligenceAppIcon %}
  {{ DiligenceAppIcon() }}
{% endrenderTemplate %}
...
{% renderTemplate "njk" %}
  {%- from 'uniuqe/case-study-diliegence.njk' import DiligencePreferenceIcons %}
